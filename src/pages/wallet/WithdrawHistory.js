...
// Filter the history data based on the formatted date  
 filteredData = withdrawHistory.filter((history) => history.today === formattedFullDate);
  ...
  return (
    ...
    data-v-e4760c44=""
    className="stateG"
    style={{ color: history.status === 0 ? "yellow" : history.status === 1 ? "green" : history.status === 3 ? "yellow" : "red" }} // Set the dynamic color here
  >
    {history.status === 0 ? "Pending" : history.status === 1 ? "Complete" :  history.status === 3 ? "Processing" : "Failed"}
  </span>
              ...
              <div data-v-e4760c44="" className="rechargeh__container-content__item-body">
                ...
                { history.status == 2 && history.wallet &&
                <div data-v-e4760c44="">
  <textarea
    data-v-e4760c44=""
    className="textarea"
    ...
    rows="10"
    readOnly
    value={`Reason- ${JSON.stringify(history.wallet)}`}
  />
</div>
}
