...
const [upiValue, setUpiValue] = useState(200);
...
const [loading, setLoading] = useState(true);
  ...
  useEffect(() => {
    if (error) {
      ...
      setError(null); // Reset error after showing the toast
    }
  }, [error]);
...
const showSection = (sectionId) => {
  ...
  const handleUpiDeposit = async () => {
    ...
    try {
        const response = await Api.post('/createUpiPaymentOrder', {
            amount: upiValue,
        });
        ...
        console.error("Error while creating UPI payment order:", error);
          ...
          <div data-v-9e03166f="" className="Recharge__content">
            ...
            <div data-v-9e03166f="" className="Recharge__content-paymoney boxStyle">
              ...
              >
                ...
                <div
                  data-v-9e03166f=""
                  className={`Recharge__content-paymoney__money-list__item ${upiValue == 200 ? 'active' : ''}`}  
                  onClick={() => handleUpiClick('200')}          
                > 
                  <div data-v-9e03166f="" className="amount">
                    <span data-v-9e03166f="">₹</span>200
                  </div>                  
                </div>
                <div
                  data-v-9e03166f=""
