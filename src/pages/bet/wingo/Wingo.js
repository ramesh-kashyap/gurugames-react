...
export default function Wingo() {
  ...
  useEffect(() => {
    ...
    const showSection = (sectionId) => {
      ...
      useEffect(() => {
        const muteState = localStorage.getItem("isMuted") === "true";
        setIsMuted(muteState);
        // Apply mute state to all audio elements on page load
      ...
      const toggleMute = (mute) => {
        // Mute/unmute audio1 using ref
    if (audio1Ref.current) {
      audio1Ref.current.muted = mute;
    }
...
<audio ref={audio1Ref} src="/assets/audio/di1.da40b233.mp3" muted={isMuted} />
<ReactHowler
  src="/assets/audio/di2.317de251.mp3"
  playing={playAudio2}
  loop={false}
  volume={isMuted ? 0 : 1.0} // Mute based on isMuted state
  onEnd={() => setPlayAudio2(false)}
/>
      ...
      <div data-v-12a80a3e="" className="navbar-fixed">
        <div data-v-12a80a3e="" className="navbar__content">
          ...
          <div data-v-12a80a3e="" className="navbar__content-center">
            ...
            <div
              data-v-12a80a3e=""
              className="navbar__content-title"
            ></div>
          </div>
          <div data-v-12a80a3e="" className="navbar__content-right">
            <div data-v-5d71c3fd="" className="WinGo__C-head-more">
              ...
              ></div>
              <div data-v-5d71c3fd=""  className={isMuted ? "disableVoice" : ""}
                onClick={handleMuteToggle}></div>
            </div>
          </div>
        </div>
      </div>
