...
useEffect(() => {
  ...
  const startCountdown = () => {
    intervalId = setInterval(() => {
      ...
      const minute = Math.ceil(minutes % 5);
            ...
            <div data-v-12a80a3e="" className="navbar__content">
              ...
              <div data-v-12a80a3e="" className="navbar__content-center">
                <div
                  data-v-12a80a3e=""
                  className="headLogo"
                  style={{ backgroundImage: `url('/assets/png/KHEL-MANTRA.png')` }}
                ></div>
  ...
  <div data-v-17d56002="" className="GameList__C-item  active" onClick={() => {navigate('/AllLotteryGames/K3/5');}}>
