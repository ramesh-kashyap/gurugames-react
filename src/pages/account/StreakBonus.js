              ...
              <div data-v-9f5f4114="" className="record__main-info">
                ...
                >
                  ...
                  <div data-v-9f5f4114="" className="flex_between">
                    <div data-v-9f5f4114="" className="rechargeFail"  style={{ color: history.status === 0 ? "#a3a314" : history.status === 1 ? "green" : "red" }}>{history.status === 0 ? "Pending" : history.status === 1 ? "Complete" : "Failed"}</div>
                ...
                >
                  ...
                  {    history.status === 1           ?
                  <div data-v-9f5f4114="">
                    <span data-v-9f5f4114="">₹ {history.amount}</span
                    >
                  </div>
                          :
                  <div data-v-9f5f4114="">
