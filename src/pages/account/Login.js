...
const [isDropdownOpen, setIsDropdownOpen] = useState(false);
  ...
  const handleSubmit = async (e) => {
      ...
      // Remove the '+' from the selected country code
      const countryCode = selectedCountry.replace('+', '');

      // Prepare login data based on the active tab
      const loginData = activeTab === 'phone' ? { username, pwd: password ,countryCode } : { username:email, pwd: password ,countryCode };
  ...
  const countries = [
    ...
    { code: '+971', name: 'United Arab Emirates (الإمارات العربية المتحدة)' },
    { code: '+54', name: 'Argentina' },
    { code: '+880', name: 'Bangladesh (বাংলাদেশ)' },
    { code: '+975', name: 'Bhutan (འབྲུག)' },
    { code: '+267', name: 'Botswana' },
    { code: '+1', name: 'Canada' },
    { code: '+235', name: 'Chad (Tchad)' },
    { code: '+269', name: 'Comoros (جزر القمر)' },
    { code: '+243', name: 'Congo (DRC) (Jamhuri ya Kidemokrasia ya Kongo)' },
    { code: '+20', name: 'Egypt (مصر)' },
    { code: '+251', name: 'Ethiopia' },
    { code: '+33', name: 'France' },
    { code: '+995', name: 'Georgia (საქართველო)' },
    { code: '+233', name: 'Ghana (Gaana)' },
    { code: '+91', name: 'India (भारत)' },
    { code: '+39', name: 'Italy (Italia)' },
    { code: '+7', name: 'Kazakhstan (Казахстан)' },
    { code: '+254', name: 'Kenya' },
    { code: '+383', name: 'Kosovo' },
    { code: '+231', name: 'Liberia' },
    { code: '+218', name: 'Libya (ليبيا)' },
    { code: '+212', name: 'Morocco (المغرب)' },
    { code: '+977', name: 'Nepal (नेपाल)' },
    { code: '+234', name: 'Nigeria' },
    { code: '+92', name: 'Pakistan (پاکستان)' },
    { code: '+51', name: 'Peru (Perú)' },
    { code: '+974', name: 'Qatar (قطر)' },
    { code: '+7', name: 'Russia (Россия)' },
    { code: '+250', name: 'Rwanda' },
    { code: '+966', name: 'Saudi Arabia (المملكة العربية السعودية)' },
    { code: '+27', name: 'South Africa' },
    { code: '+94', name: 'Sri Lanka (ශ්‍රී ලංකාව)' },
    { code: '+249', name: 'Sudan (السودان)' },
    { code: '+255', name: 'Tanzania' },
    { code: '+90', name: 'Turkey (Türkiye)' },
    { code: '+39', name: 'Vatican City (Città del Vaticano)' },
    { code: '+212', name: 'Western Sahara (الصحراء الغربية)' },
  ...
  return (
    ...
    <div id="app" data-v-app="">
          ...
          <div data-v-647954c7="" className="loading-animat">
            ...
            >
              ...
              <g clipPath="url(#__lottie_element_2)">
                ...
                <g
                  className="png"
                  transform="matrix(0.8960543870925903,0,0,0.8960543870925903,55.19728088378906,55.19728088378906)"
                  opacity="1"
                  style={{display: 'block'}}
                >
                  <image
          ...
          <div data-v-12a80a3e="" className="navbar-fixed">
            <div data-v-12a80a3e="" className="navbar__content">
              ...
              <div data-v-12a80a3e="" className="navbar__content-right">
                <div data-v-8610bd15="" data-v-47f4cc84="">
                  <div data-v-8610bd15="" className="right">
                    <div data-v-8610bd15="" className="img">
                      <img
                        data-v-8610bd15=""
                        className=""
                        data-origin="/assets/png/en-4c6eba8e.png"
                        src="/assets/png/en-4c6eba8e.png"
                      />
                    </div>
                    EN
                  </div>
          ...
          <div data-v-47f4cc84="" className={`tab-content ${activeTab === 'phone' ? 'activecontent' : ''}`}>
            ...
            >
              ...
              <div
                data-v-50aa8bb0=""
                data-v-33f88764=""
                className="phoneInput__container"
              >
      ...
      <div data-v-5067ef5e="" data-v-50aa8bb0="" className="dropdown">
        ...
        >
          <span data-v-5067ef5e="">{selectedCountry}</span>
          <FontAwesomeIcon icon={faChevronDown} />
        </div>

        {isDropdownOpen && (
          <div data-v-5067ef5e="" className="dropdown__list active">
            {countries.map((country) => (
              <div
                key={country.code}
                data-v-5067ef5e=""
                className={`dropdown__list-item ${selectedCountry === country.code ? 'active' : ''}`}
                onClick={() => handleCountrySelect(country.code)}
              >
                <span data-v-5067ef5e="">{country.code}</span> {country.name}
              </div>
            ))}
          </div>
        )}
      ...
      /><img
              ...
              <div data-v-33f88764="" className="signIn_footer">
                <div data-v-33f88764="" className="forgetcon">
                  <svg
                    data-v-33f88764=""
                    className="svg-icon icon-clock_b forgetbg forgetbg"
                  >
          ...
          <div data-v-47f4cc84="" className={`tab-content ${activeTab === 'email' ? 'activecontent' : ''}`}>
            <div
              ...
              className="signIn__container"
            >
              <div data-v-4499df08="" data-v-436a69c4="" className="emailcontainer">
      ...
      /><img
              ...
              <div data-v-96e240c3="" data-v-436a69c4="" className="popups">
