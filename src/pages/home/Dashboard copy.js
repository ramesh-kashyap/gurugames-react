...
const [isVisible, setIsVisible] = useState(true);
  ...
  >
    ...
    <div className="van-overlay" style={{ zIndex: 2009,display: rechargePopup===1?'':'none' }}>
      <div
        role="dialog"
        tabIndex="0"
        className="van-popup van-popup--center van-dialog"
        aria-labelledby="Tips"
        style={{ zIndex: 2009 ,height: '4.0rem',display: rechargePopup===1?'':'none' }}
      >
  ...
  <div data-v-5cc5cfb9="" className="row wrap">
    ...
    <div data-v-5cc5cfb9="" className="row-item row-small game_flash">
      ...
      <img
        ...
        className="game_bg"
        alt=""
        data-origin="/assets/png/flash-eac62fa4.png"
